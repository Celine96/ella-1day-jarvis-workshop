    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '🛠️ 1-2 클로드 코드 + MCP', link: '/part1/1-2-install' },
          { text: '✏️ 1-3 나만의 자비스 작명 + 인터뷰', link: '/part1/1-3-naming' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '☀️ 2-3 /morning-brief 첫 실행 ⭐', link: '/part2/2-3-morning-brief' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '⚙️ 3-4 자동 routine 등록 🎯', link: '/part3/3-4-automation' },
